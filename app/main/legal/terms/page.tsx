...
export const metadata = constructMetadata({
  title: "Qryptic | Terms of Service",
  description: "Terms of Service for Qryptic",
});

const TermsPage = () => {
  return (
    <div className="px-4 py-20 max-sm:py-16">
      <MaxWidthWrapper className="prose dark:prose-invert">
        <h2>Qryptic Terms of Service</h2>
        <p>
          These Terms of Service govern your use of the website located at{" "}
          <a href="https://qryptic.io">https://qryptic.io</a> and any related services provided by
          Qryptic.
        </p>
        <p>
          By accessing <a href="https://qryptic.io">https://qryptic.io</a>, you agree to abide by
          ...
          website or using any other services provided by Qryptic.
        </p>
        <p>
          We, Qryptic, reserve the right to review and amend any of these Terms of Service at our
        ...
        <ul>
          ...
          <li>
            ...
            that abuses or disrupts our networks or any other service Qryptic provides;
          </li>
          <li>
        ...
        <p>
          ...
          licensed to Qryptic and are protected by applicable copyright and trademark law. We grant
        ...
        <p>
          ...
          and may be terminated by Qryptic at any time.
        </p>
        ...
        <p>
          ...
          extent permitted by law, Qryptic makes no warranties, expressed or implied, and hereby
        ...
        <p>
          In no event shall Qryptic or its suppliers be liable for any consequential loss suffered
          or incurred by you or any third party arising from the use or inability to use this
          website or the materials on this website, even if Qryptic or an authorized representative
        ...
        <p>
          ...
          information purposes only. Qryptic does not warrant or make any representations concerning
        ...
        <h3>Links</h3>
        <p>
          Qryptic has not reviewed all of the sites linked to its website and is not responsible for
          the contents of any such linked site. The inclusion of any link does not imply
          endorsement, approval or control by Qryptic of the site. Use of any such linked site is at
