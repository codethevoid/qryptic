...
export const metadata = constructMetadata({
  title: "Qryptic | Privacy Policy",
  description: "Privacy Policy for Qryptic",
});
  ...
  return (
    <div className="px-4 py-20 max-sm:py-16">
      <MaxWidthWrapper className="prose dark:prose-invert">
        <h2>Qryptic Privacy Policy</h2>
        <p>
          Your privacy is important to us. It is Qryptic's policy to respect your privacy and comply
          ...
          <a href="https://qryptic.io">https://qryptic.io</a>, and other sites we own and operate.
        </p>
        <p>
        ...
        <p>
          ...
          heading or in the text) are only a reference to that state's law and applies only to that
          state's residents. Non-state specific language applies to all of the states listed above.
        </p>
        <h4>Do Not Track</h4>
        <p>
