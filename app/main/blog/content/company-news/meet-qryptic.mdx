...
export const metadata = {
  ...
  description: "Qryptic takes link management to the next level with custom domains, dynamic QR codes, and robust analytics.",
...
<a href="https://app.qryptic.io/register">Sign up</a> for **free** and start doing more with your links.
