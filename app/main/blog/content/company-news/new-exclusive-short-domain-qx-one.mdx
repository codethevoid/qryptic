export const metadata = {
  ...
  description: "Introducing qx.one, our exclusive short domain now available to all paid plan users for a polished short domain option.",
  image: "https://qryptic.s3.us-east-1.amazonaws.com/main/blogs/qx-one.png",
...
<img src="https://qryptic.s3.us-east-1.amazonaws.com/main/blogs/default-domains.png" alt="qryptic default domains dashboard" height="326" width="1308" className="rounded-xl border shadow-lg" />
